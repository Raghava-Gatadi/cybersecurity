...
def scan(ip_range, start_port, end_port):
    devices = []
    ...
    for sent, received in result:
        ...
        devices.append([received.psrc, received.hwsrc, open_ports])
...
def home(request):
    ...
    if request.method == 'POST':
        ip_range = request.POST['ip_address']
        start_port = int(request.POST['start'])
        end_port = int(request.POST['end'])
        devices = scan(ip_range, start_port, end_port)
        # print(devices)
